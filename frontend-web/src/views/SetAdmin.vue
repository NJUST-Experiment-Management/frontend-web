<template>
  <el-row>
    <el-col :span="16" :offset="4">
  	  <el-form class="demo-ruleForm" :model="ruleForm" :rules="rules" ref="ruleForm" style="padding: 0 5%  0  5% ;margin-top: 10px;">
  	  	<el-form-item>
		...
		<el-form-item>
		  <el-button style="width: 40%;margin-left: 30%;" type="primary" @click="submitForm('ruleForm')">提 交</el-button>
		</el-form-item>
  	  </el-form>
  	</el-col>
  </el-row>
