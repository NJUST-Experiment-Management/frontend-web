<template>
  ...
  <el-row>
    <el-col :span="16" :offset="4">
	    ...
	    <el-form-item>
	    	<el-table height="500" :data="arranges" style="width: 100%" @selection-change="handleArrangeSelectionChange">
	    ...
	    <el-form-item>
	      <el-button :disabled="this.selectedArrange.length!==0?false:true" style="width: 40%;margin-left: 30%;" type="primary" @click="submitDeleteForm">删 除</el-button>
	    </el-form-item>
	  </el-form>
	</el-col>
  </el-row>
	...
	data() {
	  ...
	  methods: {
		handleArrangeSelectionChange(val) {
		  this.selectedArrange = val.map((item)=>{return item.arrangeId;});
