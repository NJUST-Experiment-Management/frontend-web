<template>
	<el-button @click="prePage()" style="background-color: unset;border: 0px;color:dodgerblue" type="primary">返回</el-button>
	<el-row>
	  <el-col :span="16" :offset="4">
		<el-form :rules="rules" :model="addForm" ref="addForm">
		  ...
		  <div style="display: flex;flex-direction: row;justify-content: space-around;">
		    <div style="display: flex;flex-direction: column;align-items: flex-start;">
		      <el-form-item prop="courseStartWeek" label="起始周次:">
		        <div>
		      	<el-input-number
		      	    v-model="addForm.courseStartWeek"
		      	    :min="1"
		      	    :max="20"
			  ...
			  <el-form-item prop="courseDay" label="周几:">
			    <div>
			  	<el-select multiple @change="exploreRooms()" v-model="addForm.courseDay" placeholder="选择周几" style="margin-left: 1.25rem;">
			  	  <el-option
		    ...
		    <div style="display: flex;flex-direction: column;align-items: flex-start;">
			  ...
			  <el-form-item prop="courseTime" label="大节:">
			    <div>
			  	<el-select multiple @change="exploreRooms()" v-model="addForm.courseTime" placeholder="选择大节" style="margin-left: 1.25rem;">
			  	  <el-option
		  ...
		  <el-form-item>
		    <el-button :disabled="(this.courseTotal<=this.total) ? false : true" style="width: 40%;margin-left: 30%;" type="primary" @click="submitForm()">提 交</el-button>
		  </el-form-item>
		</el-form>
	  </el-col>
	</el-row>
  ...
  export default {
	...
	data() {
	  ...
	  methods: {
		...
		exploreRooms(){
		  if(this.addForm.courseDay.length!==0&&this.addForm.courseStartWeek!==''&&this.addForm.courseEndWeek!==''&&this.addForm.courseTime.length!==0&&this.addForm.roomKind!==''&&this.addForm.isShared!==''){
			let explore = { }
			...
			console.log(explore)
			this.rooms = [{roomId:'1001',number: 12},{roomId:'1002',number: 52},{roomId:'1004',number: 45},]
